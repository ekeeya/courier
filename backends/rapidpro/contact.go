...
INSERT INTO 
	contacts_contact(org_id, is_active, is_blocked, is_stopped, status, uuid, created_on, modified_on, created_by_id, modified_by_id, name) 
              VALUES(:org_id, TRUE, FALSE, FALSE,'A', :uuid, :created_on, :modified_on, :created_by_id, :modified_by_id, :name)
RETURNING id
`
